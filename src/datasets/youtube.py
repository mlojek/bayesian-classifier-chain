...
YOUTUBE_DATASET_URL = "https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/multilabel/youtube_deepwalk.svm.bz2"
...
def load_youtube_dataset() -> Bunch:
    ...
    """
    extracted_path = "youtube_deepwalk.svm"

    if not os.path.exists(extracted_path):
        logger.info("Youtube dataset not found, downloading and decompressing in memory...")

        response = requests.get(YOUTUBE_DATASET_URL, stream=True, verify=False)
